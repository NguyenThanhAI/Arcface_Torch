...
def get_args():
    ...
    parser.add_argument("--images_dir", type=str, default=r"D:\Face_Datasets\celeba_chosen_iden")
    #parser.add_argument("--save_dir", type=str, default=r"D:\Face_Datasets\facenet_pytorch_torchattacks_images")
    parser.add_argument("--save_dir", type=str, default=r"D:\Face_Datasets\celeba_torchattacks_images")
...
class FaceDataset(Dataset):
    def __init__(self, images_dir: str) -> None:
        ...
        identities.sort(key=lambda x: int(x))
